...
style.textContent = `
  ...
  .chat-footer {
    display: flex;
    border-top: 1px solid #B2DFDB; /* Soft teal border */
  }
  .chat-input {
    flex-grow: 1;
    border: none;
...
function addChatBotButton() {
  ...
  // Create button container to hold both the image and tooltip
  const buttonContainer = document.createElement("div");
  buttonContainer.id = "chat-bot-button-container";
  ...
  // Create the tooltip element (hidden by default)
  const tooltip = document.createElement("span");
  tooltip.textContent = "Debug Bot";
  tooltip.style.position = "absolute";
  tooltip.style.backgroundColor = "#00796B";
  tooltip.style.color = "white";
  tooltip.style.padding = "5px 8px";
  tooltip.style.borderRadius = "4px";
  tooltip.style.fontSize = "12px";
  tooltip.style.whiteSpace = "nowrap";
  tooltip.style.left = "100%"; // Changed from right to left
  tooltip.style.top = "50%";
  tooltip.style.transform = "translateY(-50%)";
  tooltip.style.marginLeft = "8px"; // Changed from marginRight to marginLeft
